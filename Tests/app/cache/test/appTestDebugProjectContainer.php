...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'wysow_archive_my_tweets.gravatar.twig.extension' => 'getWysowArchiveMyTweets_Gravatar_Twig_ExtensionService',
            'wysow_archive_my_tweets.twitter.archiver' => 'getWysowArchiveMyTweets_Twitter_ArchiverService',
            'wysow_archive_my_tweets.twitter.oauth' => 'getWysowArchiveMyTweets_Twitter_OauthService',
            'wysow_archive_my_tweets.twitter.twig.extension' => 'getWysowArchiveMyTweets_Twitter_Twig_ExtensionService',
        );
        $this->aliases = array(
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'archivemytweets-symfony', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'nativoo', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4e989ac2d8006214a0a3b6d88a440db9');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4e989ac2d8006214a0a3b6d88a440db9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4e989ac2d8006214a0a3b6d88a440db9');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Entity')), 'Wysow\\ArchiveMyTweetsBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('WysowArchiveMyTweetsBundle' => 'Wysow\\ArchiveMyTweetsBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/Resources');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/twig', 'charset' => 'UTF-8', 'debug' => true, 'paths' => array()));

        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app', 'UTF-8'));
        ...
        $instance->addExtension($this->get('wysow_archive_my_tweets.twitter.twig.extension'));
        $instance->addExtension($this->get('wysow_archive_my_tweets.gravatar.twig.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Resources/views', 'WysowArchiveMyTweets');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ThisTokenIsNotSoSecretSoCHangeIt');
    }

    /**
     * Gets the 'wysow_archive_my_tweets.gravatar.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Wysow\ArchiveMyTweetsBundle\Extension\Gravatar A Wysow\ArchiveMyTweetsBundle\Extension\Gravatar instance.
     */
    protected function getWysowArchiveMyTweets_Gravatar_Twig_ExtensionService()
    {
        return $this->services['wysow_archive_my_tweets.gravatar.twig.extension'] = new \Wysow\ArchiveMyTweetsBundle\Extension\Gravatar();
    }

    /**
     * Gets the 'wysow_archive_my_tweets.twitter.archiver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Wysow\ArchiveMyTweetsBundle\Twitter\Archiver A Wysow\ArchiveMyTweetsBundle\Twitter\Archiver instance.
     */
    protected function getWysowArchiveMyTweets_Twitter_ArchiverService()
    {
        return $this->services['wysow_archive_my_tweets.twitter.archiver'] = new \Wysow\ArchiveMyTweetsBundle\Twitter\Archiver($this->get('wysow_archive_my_tweets.twitter.oauth'), '85300487-E1iz3e1JJDZGBe3iZit0jNEtwJkREeStmay5Tmk', 'ov8yslsVqgdaMx1OVywrn1fjCTsSQv3UNItHuVguNQ', $this->get('doctrine.orm.default_entity_manager'), 'Wysow');
    }

    /**
     * Gets the 'wysow_archive_my_tweets.twitter.oauth' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return TijsVerkoyen\Twitter\Twitter A TijsVerkoyen\Twitter\Twitter instance.
     */
    protected function getWysowArchiveMyTweets_Twitter_OauthService()
    {
        return $this->services['wysow_archive_my_tweets.twitter.oauth'] = new \TijsVerkoyen\Twitter\Twitter('WTDU9bjphcJwy4PlB1Ii8A', 'CHrOMZt9lkFJ356RZiXrj6maCUcQqWDYIHgE4UzYis');
    }

    /**
     * Gets the 'wysow_archive_my_tweets.twitter.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Wysow\ArchiveMyTweetsBundle\Extension\Twitter A Wysow\ArchiveMyTweetsBundle\Extension\Twitter instance.
     */
    protected function getWysowArchiveMyTweets_Twitter_Twig_ExtensionService()
    {
        return $this->services['wysow_archive_my_tweets.twitter.twig.extension'] = new \Wysow\ArchiveMyTweetsBundle\Extension\Twitter('Wysow', 'Gaultier BONIFACE');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test',
            'kernel.logs_dir' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/logs',
            'kernel.bundles' => array(
                ...
                'WysowArchiveMyTweetsBundle' => 'Wysow\\ArchiveMyTweetsBundle\\WysowArchiveMyTweetsBundle',
            ),
            ...
            'debug.container.dump' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/appTestDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'ThisTokenIsNotSoSecretSoCHangeIt',
            ...
            'session.save_path' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/sessions',
            ...
            'router.resource' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/twig',
                'charset' => 'UTF-8',
                'debug' => true,
                'paths' => array(
            ...
            'doctrine.orm.proxy_dir' => '/var/www/archive-my-tweets-symfony/src/Wysow/ArchiveMyTweetsBundle/Tests/app/cache/test/doctrine/orm/Proxies',
            ...
            'wysow_archive_my_tweets.twitter.username' => 'Wysow',
            'wysow_archive_my_tweets.twitter.name' => 'Gaultier BONIFACE',
            'wysow_archive_my_tweets.twitter.consumer_key' => 'WTDU9bjphcJwy4PlB1Ii8A',
            'wysow_archive_my_tweets.twitter.consumer_secret' => 'CHrOMZt9lkFJ356RZiXrj6maCUcQqWDYIHgE4UzYis',
            'wysow_archive_my_tweets.twitter.oauth_token' => '85300487-E1iz3e1JJDZGBe3iZit0jNEtwJkREeStmay5Tmk',
            'wysow_archive_my_tweets.twitter.oauth_secret' => 'ov8yslsVqgdaMx1OVywrn1fjCTsSQv3UNItHuVguNQ',
            'wysow_archive_my_tweets.gravatar.email' => 'gboniface@wysow.fr',
        );
    }
}
